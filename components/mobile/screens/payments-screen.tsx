      ...
      case "visa":
        return (
          <div className="w-10 h-6 bg-blue-600 rounded flex items-center justify-center">
            <span className="text-gray-900 text-xs font-bold">VISA</span>
          </div>
        )
      case "mastercard":
        return (
          <div className="w-10 h-6 bg-gradient-to-r from-red-500 to-yellow-500 rounded flex items-center justify-center">
            <span className="text-gray-900 text-xs font-bold">MC</span>
          </div>
        )
      case "apple":
        return (
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Wallet Balance */}
        <div className="m-4 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl p-5 text-gray-900 shadow-lg">
        ...
        <div className="px-4 mb-6">
          ...
          <div className="flex gap-2 mb-3">
            ...
            />
            <button className="px-4 py-3 bg-emerald-500 text-gray-900 font-medium rounded-xl">
              Apply
            </button>
          </div>
